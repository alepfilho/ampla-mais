...
function getDimensions() {
	...
	if (largura <= 768) {
		...
		$('.drop-mobile ').addClass('dropdown-toggle').attr('data-toggle', 'dropdown')

	} else {
		$('.drop-mobile ').removeClass('dropdown-toggle').attr('data-toggle', 'no-dropdown')
		console.log("não")
	}
}
...
(function ($) {
	...
	revsliderTwo();
	function revsliderMob() {
		if ($('#slidermob').length) {
			$("#slidermob").revolution({
				sliderType: "standard",
				sliderLayout: "auto",
				delay: 9000,
				autoHeight: "on",
